...
- **zev-skill-card** — Card educacional para exibir habilidades/competências com recursos de estudo
  - Props: `title`, `badge` (differential/required/optional), `badgeLabel`, `importance`, `focusPoints`, `resources`
...
- `ZevSkillCard` wrapper com evento `onResourceClick`
- Export dos tipos: `SkillBadgeVariant`, `ResourceType`, `SkillResource`

#### Storybook

- Story `SkillCard` com 6 variantes (Default, Tipos de Badge, Com Recursos, Conteúdo Mínimo, Badge Customizado, Lista de Skills)

### Tests

- 15 novos testes unitários para `zev-skill-card`
- Total: 365 testes passando
